    ...
    <div className="pt-24 pb-16 min-h-screen bg-slate-50 dark:bg-slate-950 flex justify-center items-center font-sans">
      <Card className="w-full max-w-sm rounded-none border border-slate-200 dark:border-slate-800 shadow-none bg-white dark:bg-slate-900 p-2">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-light font-serif tracking-wider uppercase text-slate-900 dark:text-white">Login</CardTitle>
        ...
        <CardFooter className="flex-col gap-3.5 pt-4">
          ...
          <p className="text-xs text-slate-500">
            Don't have an account? <Link to={"/signup"} className="text-slate-900 dark:text-white font-bold hover:text-slate-550 transition-colors uppercase tracking-wider text-[11px] ml-1">Sign up</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
